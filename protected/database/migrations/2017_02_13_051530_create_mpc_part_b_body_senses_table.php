...
class CreateMpcPartBBodySensesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mpc_part_b_body_senses', function (Blueprint $table) {
             $table->increments('id');
             ...
             $table->timestamps();
			$table->foreign('mpc_part_b_id')->references('id')->on('mpc_part_bs')
    ...
    {
        Schema::dropIfExists('mpc_part_b_body_senses');
    }
}
