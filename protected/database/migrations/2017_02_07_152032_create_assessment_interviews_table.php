...
class CreateAssessmentInterviewsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('assessment_interviews', function (Blueprint $table) {
			   ...
			   $table->text('assess_interview_diagnosis_qn_1')->nullable();
			   $table->string('assess_interview_diagnosis_qn_2', 100 )->nullable();
			   $table->text('assess_interview_physical_issues_qn_1')->nullable();
			   $table->text('assess_interview_physical_issues_qn_2')->nullable();
