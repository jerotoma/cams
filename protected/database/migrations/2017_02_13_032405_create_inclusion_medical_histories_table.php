...
class CreateInclusionMedicalHistoriesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('inclusion_medical_histories', function (Blueprint $table) {
            ...
            $table->text('med_history_info_qn_1_remark')->nullable();
             $table->text('med_history_info_qn_2')->nullable();
              $table->text('med_history_info_qn_2_remark')->nullable();
             $table->string('med_history_info_qn_3')->nullable();
              $table->text('med_history_info_qn_3_remark')->nullable();
             $table->string('med_history_info_qn_4')->nullable();
             $table->text('med_history_info_qn_4_remark')->nullable();
             $table->string('med_history_info_qn_5')->nullable();
             $table->text('med_history_info_qn_5_remark')->nullable();
             $table->string('med_history_info_qn_6')->nullable();
             $table->text('med_history_info_qn_6_remark')->nullable();
             $table->string('med_history_info_qn_7')->nullable();
             $table->text('med_history_info_qn_7_remark')->nullable();
             $table->string('med_history_info_qn_8')->nullable();
             $table->text('med_history_info_qn_8_remark')->nullable();
             $table->string('med_history_info_qn_9')->nullable();
             $table->text('med_history_info_qn_9_remark')->nullable();
             $table->string('med_history_info_qn_10')->nullable();
             $table->text('med_history_info_qn_10_remark')->nullable();
             $table->timestamps();
    ...
    {
        Schema::dropIfExists('inclusion_medical_histories');
    }
}
