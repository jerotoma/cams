                ...
                <div class="panel panel-flat">
                    ...
                    <div class="panel-body">
                        <fieldset class="scheduler-border">
                            <legend class="scheduler-border text-primary">Personal Details</legend>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-group-material">
                                        ...
                                        <input type="text" class="form-control" placeholder="Client Number">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-group-material">
                                        ...
                                        <input type="text" class="form-control" placeholder="Name of Spouse" name="spouse_name" id="spouse_name" readonly>
                            ...
                            <div class="form-group form-group-material">
                                ...
                                <input type="text" class="form-control" placeholder="Care Giver" name="care_giver" id="care_giver">
                        ...
                        <fieldset class="scheduler-border">
                            <legend class="scheduler-border text-primary">Household Size </legend>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-group-material">
                                        <label class="control-label">Number of Males</label>
                                        <select class="select" name="males_total" id="males_total">
                                            <option value="">Number of Males</option>
                                            @for($i =0; $i<1000; $i++)
                                                <option value="{{$i}}">{{$i}}</option>
                                            @endfor
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-group-material">
                                        ...
                                        <select class="select" name="females_total" id="females_total">
                                            <option value="">Number of Females</option>
                                            @for($i =0; $i<1000; $i++)
                                                <option value="{{$i}}">{{$i}}</option>
                                            @endfor
                                        </select>
                        ...
                        <div class="form-group form-group-material">
                            <label class="control-label">Date of Arrival</label>
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control daterange-single" value="" name="date_arrival" id="date_arrival">
                                </div>
                            @if($errors->first('nationality') !="")
                                <label id="address-error" class="validation-error-label" for="nationality">{{ $errors->first('nationality') }}</label>
                            @endif
                        ...
                        <div class="form-group form-group-material">
                            ...
                            <textarea rows="5" class="wysihtml5 wysihtml5-min form-control" name="assistance_received" id="assistance_received" placeholder="Assistance Received to date (mention)...">{{old('assistance_received')}}</textarea>
                        ...
                        <div class="form-group form-group-material">
                            ...
                            <textarea rows="5" class="wysihtml5 wysihtml5-min form-control" placeholder="Problem Specification" name="problem_specification" id="assistance_received">{{old('problem_specification')}}</textarea>
