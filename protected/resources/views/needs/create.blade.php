...
<div class="portlet light bordered">
    <div class="portlet-body form">
            {!! Form::open(array('url'=>'setting/client/needs','role'=>'form','id'=>'formOrigin')) !!}
                <div class="panel panel-flat">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Need Name" name="need_name" id="need_name" value="{{old('need_name')}}">
                        </div>
                        <div class="form-group ">
