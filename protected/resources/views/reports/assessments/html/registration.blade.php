...
@section('contents')
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title text-bold text-center">Client details @if($request->start_date !="" && $request->end_date != "")as per assessment from {{$request->start_date}} to {{$request->end_date}}@endif</h5>
        </div>
