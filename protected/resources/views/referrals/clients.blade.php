            ...
            $('.datatable-basic').DataTable({
                ...
                "fnDrawCallback": function (oSettings) {
                    $(".showVulnerability").click(function(){
                        ...
                        modaldis+= '<span id="myModalLabel" class="caption caption-subject font-blue-sharp bold uppercase" style="text-align: center"><i class="fa fa-edit font-blue-sharp"></i> Client Referral </span>';
                        modaldis+= '</div>';
                        ...
                        $(".modal-body").load("<?php echo url("referrals-request") ?>/"+id1+"");
                    ...
                    $(".showRecord").click(function(){
                        ...
                        modaldis+= '<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>';
                        modaldis+= '<span id="myModalLabel" class="caption caption-subject font-blue-sharp bold uppercase" style="text-align: center"><i class="fa fa-eye font-blue-sharp"></i> Client Referral Details</span>';
                        modaldis+= '</div>';
                        modaldis+= '<div class="modal-body">';
                        modaldis+= ' </div>';
                        modaldis+= '</div>';
...
@section('page_heading_title')
    <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Client Referrals </span> </h4>
    <a class="heading-elements-toggle"><i class="icon-more"></i></a>
@stop
@section('breadcrumb')
    <ul class="breadcrumb">
        <li><a href="{{url('home')}}"><i class="icon-home2 position-left"></i> Home</a></li>
        <li><a href="{{url('referrals')}}">Client Referrals</a></li>
    </ul>
@stop
@section('contents')
    <div class="row" style="margin-bottom: 5px">
        <div class="col-md-12 text-right">
            <a  href="{{url('referrals-request')}}" class=" btn"><i class="fa fa-file text-success"></i> <span>Request Referrals</span></a>
