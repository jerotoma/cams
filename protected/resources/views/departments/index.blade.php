    ...
    <div class="sidebar-category sidebar-category-visible">
        <div class="category-content no-padding">
            <ul class="navigation navigation-main navigation-accordion">
                ...
                <li>
                    <a href="#"><i class="icon-departments"></i>Clients <span></span></a>
                    <ul>
                ...
                <!-- Layout -->
                <li class="navigation-header"><span>departments Managements</span> <i class="icon-menu" title="departments Managements"></i></li>

                <li>
                    <a href="#"><i class="icon-departments"></i> <span>departments</span></a>
                    <ul>
                        <li><a href="{{url('departments')}}">Add New User</a></li>
                        <li><a href="{{url('departments')}}">List All departments</a></li>
                        <li><a href="{{url('reports/departments')}}">User Reports</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#"><i class="icon-popout"></i> <span>departments Rights</span></a>
                    <ul>
