...
@section('scripts')
    <script>
        ...
        $(".addRecord").click(function(){
            ...
            modaldis+= '<div class="modal-header bg-indigo">';
            modaldis+= '<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>';
            modaldis+= '<span id="myModalLabel" class="text-center " style="text-align: center"><i class="fa fa-plus font-blue-sharp"></i> CBR Progressive Note</span>';
            modaldis+= '</div>';
            modaldis+= '<div class="modal-body">';
            modaldis+= ' </div>';
            modaldis+= '</div>';
            ...
            <!-- /forms -->
                ...
                <li class="active">
                    ...
                    <ul>
                        ...
                        <li class="active"><a href="{{url('progressive/notices')}}">Progressive Note</a></li>
                    </ul>
                </li>
                @permission('backup')
            <!-- Backup Restore-->
...
@section('breadcrumb')
    <ul class="breadcrumb">
        ...
        <li><a href="{{url('progressive/notices')}}">CBR Progressive Note</a></li>
    </ul>
@stop
@section('contents')
