...
@section('contents')
    <div class="row" style="margin-bottom: 5px">
        <div class="col-md-12 text-right">
              ...
              <a  href="{{url('assessments/inclusion')}}" class="btn  "><i class="fa fa-list text-info"></i> <span>List All Assessments</span></a>
              <a  href="{{url('import/assessments/inclusion')}}" class="btn "><i class="fa fa-upload text-danger"></i> <span>Import</span></a>
        </div>
    </div>
