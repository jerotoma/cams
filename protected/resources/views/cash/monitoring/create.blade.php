...
<div class="panel panel-white">
    ...
    {!! Form::open(array('url'=>'post/cash/monitoring','role'=>'form','class'=>'form-ajax','id'=>'formClients')) !!}
    ...
    <fieldset class="step" id="ajax-step2">
        ...
        <div class="form-group ">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control pickadate" placeholder="Date of interview" value="{{old('interview_date')}}" name="interview_date" id="interview_date">
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group ">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control pickatime"  name="interview_start_time" id="interview_start_time">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group ">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon"><i class="icon-alarm"></i></span>
                        <input type="text" class="form-control pickatime" name="interview_end_time" id="interview_end_time">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <textarea name="q4_21" class="form-control"></textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
        ...
        <fieldset class="step" id="ajax-step7">
            ...
            <div class="form-group">
                ...
                <textarea name="enumerator_observations" class="form-control"></textarea>
            </div>
