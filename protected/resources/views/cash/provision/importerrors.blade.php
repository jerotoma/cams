...
@section('contents')
    <div class="row" style="margin-bottom: 5px">
        <div class="col-md-12 text-right">
            <a  href="{{url('download/import/cash/monitoring/provision/errors')}}" class="btn btn-primary "><i class="fa fa-list "></i> <span>Download to Excel</span></a>
            @permission('edit')
            <a  href="{{url('bulk/cash/monitoring/provision')}}" class="btn btn-primary"><i class="fa fa-upload"></i> <span>Return to Import Clients</span></a>
            @endpermission
        </div>
    </div>
