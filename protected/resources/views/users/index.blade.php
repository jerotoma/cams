...
@section('contents')
       <div class="row" style="margin-bottom: 5px">
        <div class="col-md-12 text-right">
            <a  href="#" class="addRecord btn"><i class="fa fa-file-o text-success"></i> <span>Register New User</span></a>
            <a  href="{{url('clients')}}" class="btn  "><i class="fa fa-list text-info"></i> <span>List All Users</span></a>
            <a  href="{{url('access/rights')}}" class="btn  "><i class="fa fa-list text-info"></i> <span>User Access Rights</span></a>
        </div>
    </div>
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">System User</h5>
        </div>
