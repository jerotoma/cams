...
<div class="portlet light bordered">
    <div class="portlet-body form">
        {!! Form::open(array('url'=>'inventory/received/create','role'=>'form','id'=>'DepartmentFormUN')) !!}
        <div class="form-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
                            ...
                            <div class="input-group input-medium date date-picker" data-date="" data-date-format="yyyy-mm-dd" data-date-viewmode="years" data-date-end-date="+0d">
                                <input type="text" class="form-control" name="received_date" id="received_date" readonly>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
                            ...
                            <input type="text" class="form-control" name="way_bill_number" id="way_bill_number" value="" >
                        </div>
