...
@section('scripts')
    <script>
        ...
        $(".editRecord").click(function(){
            ...
            modaldis+= '<span id="myModalLabel" class="caption caption-subject font-blue-sharp bold uppercase" style="text-align: center"><i class="fa fa-edit font-blue-sharp"></i> Update Region Details </span>';
            modaldis+= '</div>';
            ...
            $(".modal-body").load("<?php echo url("regions") ?>/"+id1+"/edit");
        ...
        $(".addRecord").click(function(){
            ...
            modaldis+= '<div class="modal-header bg-indigo">';
            modaldis+= '<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>';
            modaldis+= '<span id="myModalLabel" class="caption caption-subject font-blue-sharp bold uppercase" style="text-align: center"><i class="fa fa-plus font-blue-sharp"></i> Add new Region</span>';
            modaldis+= '</div>';
            modaldis+= '<div class="modal-body">';
            modaldis+= ' </div>';
            modaldis+= '</div>';
            ...
            <!-- Settings -->
                ...
                <li class="active">
                    ...
                    <ul>
                        ...
                        <li class="active"><a href="{{url('regions')}}">Regions</a></li>
...
@section('contents')
    <div class="row" style="margin-bottom: 5px">
        <div class="col-md-12 text-right">
            ...
            <a  href="{{url('regions')}}" class="btn btn-primary "><i class="fa fa-list"></i> <span>List All</span></a>
            <a  href="{{url('regions')}}" class="btn btn-primary "><i class="fa fa-search"></i> <span>Search</span></a>
        </div>
    </div>
